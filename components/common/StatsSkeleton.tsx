...
const StatsSkeleton: React.FC = () => {
    return (
        <div className="space-y-8 animate-pulse">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 h-[400px] flex gap-8">
                <div className="flex-1 space-y-8 py-4">
                    <div className="h-6 w-40 bg-slate-200 rounded self-end ml-auto"></div>
                    ...
                    <div className="h-24 w-full bg-slate-100 rounded-2xl mt-auto"></div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="bg-white p-8 rounded-3xl h-80 border border-slate-100">
